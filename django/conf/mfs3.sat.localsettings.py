...
MEDIA_ROOT = '/var/apps/website/mfs3.sat/uploads/'
...
my_BASE_DIR = '/var/apps/website/mfs3.sat/current/django/'
my_UPLOADS_DIR = '/var/apps/website/mfs3.sat/uploads/'
my_SOURCE_BASE_DIR = '/var/apps/website/mfs3.sat/current/django_source/'
...
fg_LOG_DIR = '/var/apps/website/mfs3.sat/shared/log/'
...
VIDEO = {
    'default_font_file': '/var/apps/website/mfs3.sat/current/django/flowgram/core/exporters/video/GothamRnd-Medium.otf',

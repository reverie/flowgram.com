...
DATABASE_HOST = 'localhost'             # NEW INTERNAL IP
DATABASE_PORT = ''             # Set to empty string for default. Not used with sqlite3.
DATABASE_HOST_BLOG = 'localhost'
...
my_DEV_STATIC_FLEX_MEDIA = '/var/apps/flexclient2/dev/current/public/'

my_WOWKASTDIR = my_UPLOADS_DIR + 'fgrams/'
PROCESSED_AUDIO_DIR = my_UPLOADS_DIR + "processed_audio/"

fg_LOG_DIR = '/var/apps/website/dev/shared/log/'
...
HYPER_ESTRAIER_DB_PATH = "/var/apps/website/dev/shared/casket"

VIDEO = {
    'default_font_file': '/var/apps/website/dev/current/django/flowgram/core/exporters/video/Arial.ttf',

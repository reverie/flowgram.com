...
MEDIA_ROOT = '/var/apps/website/beta/uploads/'
...
my_BASE_DIR = '/var/apps/website/beta/current/django/'
my_UPLOADS_DIR = '/var/apps/website/beta/uploads/'
my_SOURCE_BASE_DIR = '/var/apps/website/beta/current/django_source/'
...
my_DEV_STATIC_FLEX_MEDIA = '/var/apps/flexclient2/beta/current/public/'

my_WOWKASTDIR = my_UPLOADS_DIR + 'fgrams/'
PROCESSED_AUDIO_DIR = my_UPLOADS_DIR + "processed_audio/"

fg_LOG_DIR = '/var/apps/website/beta/shared/log/'
...
HYPER_ESTRAIER_DB_PATH = "/var/apps/website/beta/shared/casket"

VIDEO = {
    'default_font_file': '/var/apps/website/beta/current/django/flowgram/core/exporters/video/Arial.ttf',

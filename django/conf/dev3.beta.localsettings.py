...
MASTER_DOMAIN_NAME = 'beta.flowgram.com'

# Avatars will go in the "avatars" subdirectory of this:"
MEDIA_ROOT = '/var/apps/website/dev3.beta/uploads/'
...
my_BASE_DIR = '/var/apps/website/dev3.beta/current/django/'
my_UPLOADS_DIR = '/var/apps/website/dev3.beta/uploads/'
my_SOURCE_BASE_DIR = '/var/apps/website/dev3.beta/current/django_source/'
...
fg_LOG_DIR = '/var/apps/website/dev3.beta/shared/log/'
...
S3_BUCKETS = {
    ...
    S3_BUCKET_PPT : "ppt.flowgram.com",
